...
def load_gsm8k(n: int, split: str = "test"):
    try:
        ...
        # Fallback tiny prompts (smoke-test only)
        fallback = [
...
def main():
    ...
    print("RefreshKV Baseline Summary")
    ...
    if refresh_steps == 0:
        print("WARNING: no refresh events fired; consider lowering similarity_threshold or qc_stride.")
